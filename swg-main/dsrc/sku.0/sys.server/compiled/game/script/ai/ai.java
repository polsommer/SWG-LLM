...
public class ai extends script.base_script
{
    ...
    public int handlePerformAmbientLife(obj_id self, dictionary params) throws InterruptedException
    {
        ai_lib.performModernAmbientLife(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public void doDefaultCalmBehavior(obj_id npc) throws InterruptedException
    {
        ...
        switch (defaultBehavior)
        {
            ...
            case ai_lib.BEHAVIOR_SENTINEL:
                ...
                stop(npc);
                ai_lib.scheduleModernAmbientLife(npc, true);
                break;
