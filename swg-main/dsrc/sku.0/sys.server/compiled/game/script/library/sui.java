...
public class sui extends script.base_script
{
    ...
    public static final String DAILY_INTEREST_PAGE_PROMPT = "Prompt";
    public static final String DAILY_INTEREST_PAGE_CAPTION = "bg.caption";
    public static final String DAILY_INTEREST_TITLE = DAILY_INTEREST_PAGE_CAPTION + ".lblTitle";
    public static final String DAILY_INTEREST_PROMPT = DAILY_INTEREST_PAGE_PROMPT + ".lblPrompt";
    public static final String DAILY_INTEREST_BTN_OK = "btnOk";
    public static final String DAILY_INTEREST_BTN_CANCEL = "btnCancel";
    public static final string_id MSG_DAILY_INTEREST_TITLE = new string_id("sui", "daily_interest_title");
    public static final string_id MSG_DAILY_INTEREST_PROMPT = new string_id("sui", "daily_interest_prompt");
    public static final String HANDLER_DAILY_INTEREST = "handleDailyInterest";
