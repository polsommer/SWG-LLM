...
public class force_rank extends script.base_script
{
    ...
    public static final String SCRIPT_VAR_SHOP_TERMINAL = "force_rank.shop_terminal";
    ...
    public static void refreshPlayerEnclaveAccess(obj_id player) throws InterruptedException
    {
        if (!isIdValid(player) || !isPlayer(player))
        {
            return;
        }
        if (!isForceRanked(player))
        {
            return;
        }
        int council = getCouncilAffiliation(player);
