            ...
            else 
            {
                ...
                if (isIdValid(ship))
                {
                    ...
                    if (isModularCraftingAvailable())
                    {
                        try
                        {
                            space_modular_crafting.initializeShipModules(pcd, ship, type);
                            if (!hasScript(pcd, "space.crafting.modular_ship_manager"))
                            {
                                attachScript(pcd, "space.crafting.modular_ship_manager");
                            }
                        }
