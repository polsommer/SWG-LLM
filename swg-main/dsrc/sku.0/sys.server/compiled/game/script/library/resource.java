...
public class resource extends script.base_script
{
    ...
    public static final int BASE_SAMPLE_AMOUNT = 25;
    ...
    public static float HAND_SAMPLE_BONUS = 5;
    ...
    public static boolean requestSetToolRatio(obj_id user, obj_id tool) throws InterruptedException
    {
        ...
        int rangeVal = getSkillStatMod(user, "surveying") / 10;
        if (rangeVal < 1)
        {
            rangeVal = 1;
        }
    ...
    public static int getSample(obj_id user, obj_id tool, String type) throws InterruptedException
    {
        ...
        if (density > threshold)
        {
            ...
            if ((roll <= chance) || (gamble > 0) || (nodecritloc != null))
            {
                ...
                HAND_SAMPLE_BONUS = utils.stringToFloat(getConfigSetting("GameServer", "harvesterExtractionRateMultiplier"));
                if (HAND_SAMPLE_BONUS >1){
                    amt = (int) (amt * HAND_SAMPLE_BONUS);
                }
