...
public class gcw extends script.base_script
{
    ...
    public static final String[] INVASION_CITIES =
    {
        "bestine",
        "coronet",
        "dearic",
    ...
    public static final String CORONET_CITY_TABLE = "datatables/gcw/gcw_city_coronet.iff";
    public static final String MOS_EISLEY_CITY_TABLE = "datatables/gcw/gcw_city_mos_eisley.iff";
    public static final String THEED_CITY_TABLE = "datatables/gcw/gcw_city_theed.iff";
    ...
    public static final String CITY_CORONET = "coronet";
    public static final String CITY_MOS_EISLEY = "mos_eisley";
    public static final String CITY_THEED = "theed";
    private static final Hashtable<String, String> CITY_BY_DATATABLE = new Hashtable<>();

    static
    {
        CITY_BY_DATATABLE.put(DEARIC_CITY_TABLE, CITY_DEARIC);
        CITY_BY_DATATABLE.put(KEREN_CITY_TABLE, CITY_KEREN);
        CITY_BY_DATATABLE.put(BESTINE_CITY_TABLE, CITY_BESTINE);
        CITY_BY_DATATABLE.put(CORONET_CITY_TABLE, CITY_CORONET);
        CITY_BY_DATATABLE.put(MOS_EISLEY_CITY_TABLE, CITY_MOS_EISLEY);
        CITY_BY_DATATABLE.put(THEED_CITY_TABLE, CITY_THEED);
    }
    ...
    public static String getCityFromTable(obj_id self) throws InterruptedException
    {
        ...
        String cityName = CITY_BY_DATATABLE.get(datatable);
        if (cityName != null && cityName.length() > 0)
        {
            return cityName;
        }

        CustomerServiceLog("gcw_city_invasion", "gcw.getCityFromTable: Sequencer " + self + " has an unmapped datatable path [" + datatable + "]. Update CITY_BY_DATATABLE in gcw.java.");
        return null;
    }
    public static boolean awardGcwInvasionParticipants(Vector participantList, int factionFlag, int gcwTokenAmt, int gcwPointAmt, dictionary finalAnnouncementParams) throws InterruptedException
    {
        ...
        for (Object o : participantList) {
            ...
            guild.recordGuildPveContribution(((obj_id) o), "gcw_invasion", gcwPointAmt, "gcw_invasion");
    ...
    public static boolean gcwHasInvasionInCycle(String cityName, int cycle) throws InterruptedException
    {
        ...
        if(maxRunning > activeCities.length)
            maxRunning = activeCities.length;
        ...
        int cityDistanceFromCycle = cityIndex - cycle;
        if (cityDistanceFromCycle < 0)
        {
            cityDistanceFromCycle += activeCities.length;
        }

        return cityDistanceFromCycle < maxRunning;
        /*
    ...
    public static int gcwGetNextInvasionTime(String cityName) throws InterruptedException
    {
        ...
        LOG("gcwlog", "gcwGetNextInvasionTime next cycle check cityName=" + cityName + " invasionOnNextInterval=" + invasionOnNextInterval + " cycle=" + cycle + " hour=" + hour + " nextCycle=" + nextCycle);
