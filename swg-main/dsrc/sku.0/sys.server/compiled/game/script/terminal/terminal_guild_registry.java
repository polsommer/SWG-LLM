...
public class terminal_guild_registry extends script.base_script
{
    ...
    public static final String STR_GUILD_CREATE_INTRO_TITLE = "Guild Charter";
    public static final String STR_GUILD_CREATE_INTRO_PROMPT = "Forge a guild to turn allies into a true crew. Claim a banner, rally friends for GCW campaigns, run bounties and heroics as a squad, and build a hall worthy of your legends. From the Core to the Outer Rim, a guild makes every victory feel like a saga.";
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        if (playerGuildId == 0)
        {
            sui.msgbox(self, player, STR_GUILD_CREATE_INTRO_PROMPT, sui.OK_ONLY, STR_GUILD_CREATE_INTRO_TITLE, sui.MSG_NORMAL, "onGuildCreateIntroResponse");
        }
        return SCRIPT_CONTINUE;
    }
    public int onGuildCreateIntroResponse(obj_id self, dictionary params) throws InterruptedException
    {
