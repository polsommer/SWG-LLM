...
public class terminal_guild extends script.terminal.base.base_terminal
{
    ...
    public static final string_id SID_GUILD_OPERATIONS_BOARD = new string_id("guild", "menu_operations_board");
    ...
    public int OnObjectMenuRequest(obj_id self, obj_id player, menu_info mi) throws InterruptedException
    {
        ...
        if (guildId != 0 && (getGuildId(player) == guildId || isGod(player)))
        {
            ...
            mi.addSubMenu(guildManagementMenu, menu_info_types.SERVER_MENU24, SID_GUILD_OPERATIONS_BOARD);
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            guild.showGuildOperationsBoard(player);
        }
