...
public class terminal_character_builder extends script.base_script
{
    ...
    public static final int DEFAULT_LEVEL_CAP = 130;
    ...
    public int handleRoadmapSelect(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        switch (idx)
        {
            ...
            sui.inputbox(self, player, "Enter your desired level (1-" + getConfiguredLevelCap() + ").", "handleAutoLevelSelect");
            break;
            case 3:
    ...
    public int handleAutoLevelSelect(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        int maxLevel = getConfiguredLevelCap();
        if (level < 1 || level > maxLevel)
        {
            sendSystemMessageTestingOnly(player, "Invalid level entered! Please enter a value between 1 and " + maxLevel + ".");
        }
        else
        {
    ...
    private int getConfiguredLevelCap()
    {
        int configuredCap = utils.getIntConfigSetting("GameServer", "maxCombatLevel");
        if (configuredCap < 1)
        {
            configuredCap = DEFAULT_LEVEL_CAP;
        }
