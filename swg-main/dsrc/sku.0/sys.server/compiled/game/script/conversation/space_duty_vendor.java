...
public class space_duty_vendor extends script.base_script
{
    ...
    {
        int tokens = tokenmanager.getTokenTotal(player, tokenmanager.SPACE_DUTY_TOKEN);
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        int price = tokenmanager.getSpaceDutyTokenPrice(level);
        if (tokens >= price)
        {
            return true;
        }
    ...
    {
        if (tokenmanager.getTokenTotal(player, tokenmanager.SPACE_DUTY_TOKEN) >= 50)
        {
            return true;
        }
        return false;
    ...
    public void space_duty_vendor_action_buyInterdictionGenerator(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        if (!tokenmanager.purchaseTokenItem(player, 50, tokenmanager.SPACE_DUTY_TOKEN))
        {
