    ...
    public int ep3_carl_mosik_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_193"))
        {
            ...
            if (ep3_carl_mosik_condition__defaultCondition(player, npc))
            {
                ...
                theSet.add(static_item.createNewItemFunction("item_tcg_loot_reward_series3_wookiee_ceremonial_pipe", pInv));
                theSet.add(static_item.createNewItemFunction("item_tcg_loot_reward_series3_mandalorian_skull_banner", pInv));
