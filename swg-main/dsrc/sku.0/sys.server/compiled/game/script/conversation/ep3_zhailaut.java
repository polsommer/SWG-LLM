...
public class ep3_zhailaut extends script.base_script
{
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (ep3_zhailaut_condition_isReadyForRadioReward(player, npc))
        {
            ...
            theSet.add(static_item.createNewItemFunction("item_tcg_loot_reward_series3_greeter_battle_droid", pInv));
            theSet.add(static_item.createNewItemFunction("item_tcg_loot_reward_series2_indoor_garden_02", pInv));
