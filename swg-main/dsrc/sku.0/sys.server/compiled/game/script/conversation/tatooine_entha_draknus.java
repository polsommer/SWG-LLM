...
public class tatooine_entha_draknus extends script.base_script
{
    ...
    public boolean tatooine_entha_draknus_condition_onReturnDraknus(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "tatooine_entha_return_draknus");
    }
    ...
    public int tatooine_entha_draknus_handleBranch21(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_98"))
        {
            if (tatooine_entha_draknus_condition__defaultCondition(player, npc))
            {
                // Reset stale test-race state before starting the first race.
                tatooine_entha_draknus_action_clearRace1(player, npc);
                tatooine_entha_draknus_action_clearRace2(player, npc);
                tatooine_entha_draknus_action_clearRace3(player, npc);
                tatooine_entha_draknus_action_grantRace1(player, npc);
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (tatooine_entha_draknus_condition_onReturnDraknus(player, npc))
        {
            tatooine_entha_draknus_action_signalReturnDraknus(player, npc);
            if (!tatooine_entha_draknus_condition_onRace1(player, npc) && !tatooine_entha_draknus_condition_onRace2(player, npc) && !tatooine_entha_draknus_condition_onRace3(player, npc) && !tatooine_entha_draknus_condition_completedRace1(player, npc) && !tatooine_entha_draknus_condition_completedRace2(player, npc) && !tatooine_entha_draknus_condition_completedRace3(player, npc))
            {
                tatooine_entha_draknus_action_clearRace1(player, npc);
                tatooine_entha_draknus_action_grantRace1(player, npc);
                string_id message = new string_id(c_stringFile, "s_100");
