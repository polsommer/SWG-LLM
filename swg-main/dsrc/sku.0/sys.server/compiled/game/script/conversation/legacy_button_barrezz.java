...
public class legacy_button_barrezz extends script.base_script
{
    ...
    {
        boolean valarianComplete = legacy_button_barrezz_action_completeQuestIfTasksFinished(player, "quest/legacy_button_valarian") || legacy_button_barrezz_action_completeQuestIfTasksFinished(player, "quest/legacy_button_valarian_v2");
        return valarianComplete && !groundquests.isQuestActiveOrComplete(player, "quest/legacy_button_darklighter");
    }
    public boolean legacy_button_barrezz_action_completeQuestIfTasksFinished(obj_id player, String questName) throws InterruptedException
    {
