...
public class huff_darklighter extends script.base_script
{
    ...
    public static final String QUEST_HUFF_SENNEX = "huff_darklighter_sennex";
    public static final String TASK_FINISHED_SENNEX = "finishedSennex";
    public static final String TASK_DEFEAT_OVERLORD = "defeatSennexSlaverOverlord";
    public static final String TASK_DEFEAT_VETERANS = "defeatSennexSlaverVeterans";
    public static final String TASK_DEFEAT_SLAVE_DRIVERS = "defeatSennexSlaveDrivers";
    public static final String TASK_DOWNLOAD_DATABASE = "downloadDatabase";
    ...
    {
        return (groundquests.isTaskActive(player, "huff_darklighter_dera", "finishedDera") || groundquests.hasCompletedTask(player, "huff_darklighter_dera", "returnToDera") || groundquests.hasCompletedQuest(player, "huff_darklighter_dera"));
    }
    ...
    {
        boolean completedSennexObjectives = hasCompletedAllSennexObjectives(player);
        return (groundquests.isTaskActive(player, QUEST_HUFF_SENNEX, TASK_FINISHED_SENNEX) || (groundquests.isQuestActive(player, QUEST_HUFF_SENNEX) && completedSennexObjectives) || groundquests.hasCompletedQuest(player, QUEST_HUFF_SENNEX));
    }
    public boolean hasCompletedAllSennexObjectives(obj_id player) throws InterruptedException
    {
        return groundquests.hasCompletedTask(player, QUEST_HUFF_SENNEX, TASK_DEFEAT_OVERLORD) && groundquests.hasCompletedTask(player, QUEST_HUFF_SENNEX, TASK_DEFEAT_VETERANS) && groundquests.hasCompletedTask(player, QUEST_HUFF_SENNEX, TASK_DEFEAT_SLAVE_DRIVERS) && groundquests.hasCompletedTask(player, QUEST_HUFF_SENNEX, TASK_DOWNLOAD_DATABASE);
    }
    public void autoFixAndCompleteSennexMission(obj_id player) throws InterruptedException
    {
        if (!groundquests.isQuestActive(player, QUEST_HUFF_SENNEX) || !hasCompletedAllSennexObjectives(player))
        {
            return;
        }
        if (!groundquests.isTaskActive(player, QUEST_HUFF_SENNEX, TASK_FINISHED_SENNEX) && !groundquests.hasCompletedTask(player, QUEST_HUFF_SENNEX, TASK_FINISHED_SENNEX))
        {
            groundquests.sendSignal(player, TASK_FINISHED_SENNEX);
        }
        if (!groundquests.hasCompletedQuest(player, QUEST_HUFF_SENNEX))
        {
            groundquests.completeQuest(player, QUEST_HUFF_SENNEX);
        }
    }
    ...
    {
        groundquests.sendSignal(player, TASK_FINISHED_SENNEX);
        autoFixAndCompleteSennexMission(player);
    }
