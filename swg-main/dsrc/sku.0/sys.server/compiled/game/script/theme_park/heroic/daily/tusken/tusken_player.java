package script.theme_park.heroic.daily.tusken;
...
public class tusken_player extends script.base_script
{
    ...
    public int OnLogin(obj_id self) throws InterruptedException
    {
        ...
        {
            detachScript(self, "theme_park.heroic.daily.tusken.tusken_player");
            return SCRIPT_CONTINUE;
        }
        if (!area.equals("daily_heroic_tusken_army"))
        {
            detachScript(self, "theme_park.heroic.daily.tusken.tusken_player");
            return SCRIPT_CONTINUE;
        }
    ...
    public int update_quest(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        obj_id quest_manager = getFirstObjectWithScript(getLocation(self), 1000.0f, "theme_park.heroic.daily.tusken.tusken_quest_tracker");
    ...
    public void clearCurrentTuskenQuest(obj_id self) throws InterruptedException
    {
        String[] questToClear = 
        {
            "heroic_daily_tusken_tracking_01",
            "heroic_daily_tusken_tracking_02",
            "heroic_daily_tusken_tracking_02a",
            "heroic_daily_tusken_tracking_03"
        };
