...
public class krix extends script.base_script
{
        ...
        for (obj_id player : players) {
            ...
            if (guards != null && guards.length > 0) {
                for (obj_id guard : guards) {
                    ...
                    setHate(guard, player, rand(5, 1000));
                    startCombat(self, player);
                }
            }
        }
    ...
    public int executeFocus(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        chat.chat(self, "auuugh, you I!!!! WILL KILL U! " + getPlayerName(focus) + "!");
        ...
        messageTo(self, "executeFocus", trial.getSessionDict(self, "special"), 15.0f, false);
        return SCRIPT_CONTINUE;
    }
    public void phaseTwo(obj_id self) throws InterruptedException
    {
        chat.chat(self, "USELESS troops, I will kill you all myself.");
    ...
    public int megaBurn(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        messageTo(self, "megaBurn", trial.getSessionDict(self, "special"), 2.0f, false);
        return SCRIPT_CONTINUE;
    }
