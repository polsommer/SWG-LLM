...
public class city_pathing_npc extends script.base_script
{
    ...
    {
        obj_id homeStop = utils.getObjIdScriptVar(self, "pathing.homeStop");
        String creatureType = getStringObjVar(self, "creature_type");
        if (npc_simulation.shouldUseAdaptiveArchetypeController(self, creatureType, homeStop))
        {
            npc_simulation.attachAdaptiveArchetypeControllerIfAllowed(self, creatureType, homeStop);
        }
        return SCRIPT_CONTINUE;
    }
