...
public class city_pathing extends script.base_script
{
    ...
    public void respawnNpc(obj_id self) throws InterruptedException
    {
        ...
        npc_simulation.attachAdaptiveArchetypeControllerIfAllowed(npc, creatureName, self);
    }

    private boolean shouldSpawnNpc(obj_id self) throws InterruptedException
    {
        obj_id existing = getObjIdObjVar(self, "pathing.lastSpawned");
        return !isIdValid(existing) || !exists(existing);
    }
}
