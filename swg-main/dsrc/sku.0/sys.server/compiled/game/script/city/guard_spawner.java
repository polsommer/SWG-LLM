...
public class guard_spawner extends script.base_script
{
    ...
    public int OnInitialize(obj_id self) throws InterruptedException
    {
        ...
        ensureAdaptiveControllerForPersistedGuards(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public void doSpawn(obj_id self, boolean onlySpawnOne) throws InterruptedException
    {
        ...
        npc_simulation.attachAdaptiveArchetypeControllerIfAllowed(npc, spawn, self);
    ...
    public void ensureAdaptiveControllerForPersistedGuards(obj_id self) throws InterruptedException
    {
        if (!hasObjVar(self, "myCreations"))
        {
            return;
        ...
        Vector spawnedList = getResizeableObjIdArrayObjVar(self, "myCreations");
        if (spawnedList == null || spawnedList.size() < 1)
        {
            return;
        }
        for (Object o : spawnedList)
        {
            ...
            setObjVar(npc, npc_simulation.OBJVAR_ADAPTIVE_ELIGIBLE_SPAWNED, 1);
            npc_simulation.attachAdaptiveArchetypeControllerIfAllowed(npc, getStringObjVar(npc, "creature_type"), self);
        }
    }
