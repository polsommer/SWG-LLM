...
public class gas_recycler extends script.base_script
{
    public gas_recycler()
    {
    }
    ...
    public int OnObjectMenuRequest(obj_id self, obj_id player, menu_info mi) throws InterruptedException
    {
        ...
        string_id gas_reactive = new string_id(STF, "gas_reactive");
        string_id gas_inert = new string_id(STF, "gas_inert");
        int mnuOptions = -1;
        ...
        if (mnuOptions > 0)
        {
            int subClass2 = mi.addSubMenu(mnuOptions, menu_info_types.SERVER_MENU1, gas_reactive);
            int subClass3 = mi.addSubMenu(mnuOptions, menu_info_types.SERVER_MENU2, gas_inert);
        }
        return SCRIPT_CONTINUE;
    }
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            setObjVar(self, "current_set", "gas_reactive");
        }
        if (item == menu_info_types.SERVER_MENU2)
        {
            setObjVar(self, "current_set", "gas_inert");
        }
        return SCRIPT_CONTINUE;
    }
