...
public class crafting_garden_medium extends script.systems.crafting.structure.crafting_base_structure
{
    ...
    public static final String[] APPEARANCES = 
    {
        ...
        "object/tangible/deed/city_deed/shared_garden_dathomir_med_02_deed.iff"
    };
    public static final String[] ALT_TEMPLATES =
    {
        ...
        "object/building/player/city/garden_dathomir_med_02.iff"
    };
    public static final String[] ALT_PLANETS =
    {
        "corellia,talus,endor,dathomir,yavin4",
        "corellia,talus,endor,dathomir,yavin4",
        "corellia,talus,endor,dathomir,yavin4",
        "corellia,talus,endor,dathomir,yavin4",
        "naboo,rori,dantooine,endor,dathomir,yavin4",
        "naboo,rori,dantooine,endor,dathomir,yavin4",
        "naboo,rori,dantooine,endor,dathomir,yavin4",
        "naboo,rori,dantooine,endor,dathomir,yavin4",
        "naboo,rori,dantooine,endor,dathomir,yavin4",
        "tatooine,lok,dantooine,endor,dathomir,yavin4",
        "tatooine,lok,dantooine,endor,dathomir,yavin4",
        "tatooine,lok,dantooine,endor,dathomir,yavin4",
        "tatooine,lok,dantooine,endor,dathomir,yavin4",
        "tatooine,lok,dantooine,endor,dathomir,yavin4",
