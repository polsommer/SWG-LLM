...
public class player_building extends script.base_script
{
    ...
    public int OnPlaceStructure(obj_id self, obj_id player, obj_id deed, location position, int rotation) throws InterruptedException
    {
        ...
        if (utils.hasScriptVar(deed, player_structure.VAR_PLACEMENT_PREVIEW_TEMPLATE))
        {
            String previewTemplate = utils.getStringScriptVar(deed, player_structure.VAR_PLACEMENT_PREVIEW_TEMPLATE);
        ...
        if (utils.hasScriptVar(deed, player_structure.VAR_PLACEMENT_PREVIEW_FOOTPRINT))
        {
            String storedFootprint = utils.getStringScriptVar(deed, player_structure.VAR_PLACEMENT_PREVIEW_FOOTPRINT);
            if (storedFootprint != null && !storedFootprint.equals(""))
            {
                fp_template = storedFootprint;
            }
        }
        ...
        utils.removeScriptVarTree(deed, player_structure.VAR_PLACEMENT_PREVIEW);
